...
class cabc extends cTable {
	...
	function __construct() {
		...
		// ID
		$this->ID = new cField('abc', 'abc', 'x_ID', 'ID', '`ID`', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->ID->Sortable = TRUE; // Allow sort
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] = &$this->ID;

		// NombreProducto
		$this->NombreProducto = new cField('abc', 'abc', 'x_NombreProducto', 'NombreProducto', '`NombreProducto`', '`NombreProducto`', 200, -1, FALSE, '`NombreProducto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NombreProducto->Sortable = TRUE; // Allow sort
		$this->fields['NombreProducto'] = &$this->NombreProducto;

		// FechaIngreso
		$this->FechaIngreso = new cField('abc', 'abc', 'x_FechaIngreso', 'FechaIngreso', '`FechaIngreso`', ew_CastDateFieldForLike('`FechaIngreso`', 0, "DB"), 133, 0, FALSE, '`FechaIngreso`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FechaIngreso->Sortable = TRUE; // Allow sort
		$this->FechaIngreso->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['FechaIngreso'] = &$this->FechaIngreso;

		// Existencia
		$this->Existencia = new cField('abc', 'abc', 'x_Existencia', 'Existencia', '`Existencia`', '`Existencia`', 3, -1, FALSE, '`Existencia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Existencia->Sortable = TRUE; // Allow sort
		$this->Existencia->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Existencia'] = &$this->Existencia;

		// Proveedor
		$this->Proveedor = new cField('abc', 'abc', 'x_Proveedor', 'Proveedor', '`Proveedor`', '`Proveedor`', 3, -1, FALSE, '`Proveedor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`abc`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("abcview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("abcview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "abcadd.php?" . $this->UrlParm($parm);
		else
			$url = "abcadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("abcedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("abcadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("abcdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->FechaIngreso->EditValue = ew_FormatDateTime($this->FechaIngreso->CurrentValue, 8);
