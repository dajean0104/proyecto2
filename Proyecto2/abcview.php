...
$abc_view = NULL; // Initialize page object first

class cabc_view extends cabc {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["ID"] <> "") {
				...
				$sReturnUrl = "abclist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "abclist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "abclist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($abc_view)) $abc_view = new cabc_view();
...
var CurrentForm = fabcview = new ew_Form("fabcview", "view");

// Form_CustomValidate event
fabcview.Form_CustomValidate = 
...
fabcview.ValidateRequired = true;
<?php } else { ?>
fabcview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fabcview.Lists["x_Proveedor"] = {"LinkField":"x_ID","Ajax":true,"AutoFill":false,"DisplayFields":["x_NombreProveedor","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"proveedores"};
...
<div class="ewToolbar">
<?php if (!$abc_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $abc_view->ExportOptions->Render("body") ?>
<?php
	foreach ($abc_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$abc_view->IsModal) { ?>
...
<?php $abc_view->ShowPageHeader(); ?>
<?php
$abc_view->ShowMessage();
?>
<form name="fabcview" id="fabcview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($abc_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $abc_view->Token ?>">
<?php } ?>
...
<?php if ($abc->ID->Visible) { // ID ?>
	<tr id="r_ID">
		<td><span id="elh_abc_ID"><?php echo $abc->ID->FldCaption() ?></span></td>
		<td data-name="ID"<?php echo $abc->ID->CellAttributes() ?>>
<span id="el_abc_ID">
<span<?php echo $abc->ID->ViewAttributes() ?>>
<?php echo $abc->ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($abc->NombreProducto->Visible) { // NombreProducto ?>
	<tr id="r_NombreProducto">
		<td><span id="elh_abc_NombreProducto"><?php echo $abc->NombreProducto->FldCaption() ?></span></td>
...
<?php echo $abc->NombreProducto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($abc->FechaIngreso->Visible) { // FechaIngreso ?>
	<tr id="r_FechaIngreso">
		<td><span id="elh_abc_FechaIngreso"><?php echo $abc->FechaIngreso->FldCaption() ?></span></td>
...
<?php echo $abc->FechaIngreso->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($abc->Existencia->Visible) { // Existencia ?>
	<tr id="r_Existencia">
		<td><span id="elh_abc_Existencia"><?php echo $abc->Existencia->FldCaption() ?></span></td>
...
<?php echo $abc->Existencia->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($abc->Proveedor->Visible) { // Proveedor ?>
	<tr id="r_Proveedor">
		<td><span id="elh_abc_Proveedor"><?php echo $abc->Proveedor->FldCaption() ?></span></td>
...
<?php echo $abc->Proveedor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
